...
export const PIECE_VALUES = {
    'q': 5, 'Q': 5,  // Queen (highest)
    'r': 4, 'R': 4,  // Rook
    'b': 3, 'B': 3,  // Bishop
    'n': 3, 'N': 3,  // Knight (same as bishop)
    'p': 1, 'P': 1,  // Pawn
    'k': 100, 'K': 100, // King (never combines)
    // Hybrids inherit highest component value
    'rb': 5, 'RB': 5, // Rook+Bishop
    'rn': 4, 'RN': 4, // Rook+Knight
    'bn': 3, 'BN': 3, // Bishop+Knight
    'qn': 5, 'QN': 5, // Queen+Knight
};
...
export const ALLOWED_COMBINATIONS = [
    ['r', 'b'], ['R', 'B'], // Rook + Bishop
    ['r', 'n'], ['R', 'N'], // Rook + Knight
    ['b', 'n'], ['B', 'N'], // Bishop + Knight
    ['q', 'n'], ['Q', 'N'], // Queen + Knight
];
...
export const isHybridPiece = (piece) => {
    ...
    return normalized === PIECES.ROOK_BISHOP ||
