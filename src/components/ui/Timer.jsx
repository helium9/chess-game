...
const Timer = React.memo(({
    ...
    return (
        <div className={`
      px-4 py-2 rounded-lg font-mono text-2xl font-bold transition-all duration-300
      ${isActive ? 'bg-green-600 text-white shadow-lg shadow-green-500/50 scale-105' : 'bg-gray-700 text-gray-300'}
