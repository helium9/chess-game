...
import { createInitialGameState, undoMove, redoMove, canUndo, canRedo } from '../utils/gameState.js';
...
const ChessBoard = () => {
    ...
    // Promotion hook
    const { promotionDialog, openPromotionDialog, executePromotion } = usePromotion(
        gameState,
        setGameState,
        setMessage
    );
